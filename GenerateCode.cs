...
namespace HttpClientCode
{
    ...
    #line 1 "C:\Users\lordw\Downloads\FiddlerGenerateHttpClientCode-master\FiddlerGenerateHttpClientCode-master\HttpClientCode\HttpClientCode\GenerateCode.tt"
...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            this.Write("\n\nvar httpHandler = new HttpClientHandler();\nhttpHandler.UseCookies = false;\nhttp" +
                    "Handler.AutomaticDecompression = System.Net.DecompressionMethods.GZip | System.N" +
                    "et.DecompressionMethods.Deflate;\nvar httpClient = new HttpClient(httpHandler);\n");
	...
	if(httpmethod.ToUpper()=="GET")
    {
            ...
            #line default
            #line hidden
            this.Write("var httpRequestMessage = new HttpRequestMessage(HttpMethod.Get, \"");
 ...
 Write(uri); 
	...
	if(httpmethod.ToUpper()=="POST")
    {
            ...
            #line default
            #line hidden
            this.Write("var httpRequestMessage = new HttpRequestMessage(HttpMethod.Post, \"");
...
if(string.IsNullOrEmpty(bodycontent) == false)
{
 ...
 Write(contenttypename); 
            ...
            this.Write("\nvar httpResponseMessage = httpClient.SendAsync(httpRequestMessage).Result;\nvar h" +
                    "ttpContent = httpResponseMessage.Content;\nstring result = httpResponseMessage.Co" +
                    "ntent.ReadAsStringAsync().Result;\n");
...
private string _bodycontentField;

/// <summary>
/// Access the bodycontent parameter of the template.
/// </summary>
private string bodycontent
{
    get
    {
        return this._bodycontentField;
    }
}

private string _encodingtypenameField;

/// <summary>
/// Access the encodingtypename parameter of the template.
/// </summary>
private string encodingtypename
{
    get
    {
        return this._encodingtypenameField;
    }
}

private string _contenttypenameField;

/// <summary>
/// Access the contenttypename parameter of the template.
/// </summary>
private string contenttypename
{
    get
    {
        return this._contenttypenameField;
    }
}
...
bool bodycontentValueAcquired = false;
if (this.Session.ContainsKey("bodycontent"))
{
    this._bodycontentField = ((string)(this.Session["bodycontent"]));
    bodycontentValueAcquired = true;
}
if ((bodycontentValueAcquired == false))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("bodycontent");
    if ((data != null))
    {
        this._bodycontentField = ((string)(data));
    }
}
bool encodingtypenameValueAcquired = false;
if (this.Session.ContainsKey("encodingtypename"))
{
    this._encodingtypenameField = ((string)(this.Session["encodingtypename"]));
    encodingtypenameValueAcquired = true;
}
if ((encodingtypenameValueAcquired == false))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("encodingtypename");
    if ((data != null))
    {
        this._encodingtypenameField = ((string)(data));
    }
}
bool contenttypenameValueAcquired = false;
if (this.Session.ContainsKey("contenttypename"))
{
    this._contenttypenameField = ((string)(this.Session["contenttypename"]));
    contenttypenameValueAcquired = true;
}
if ((contenttypenameValueAcquired == false))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("contenttypename");
    if ((data != null))
    {
        this._contenttypenameField = ((string)(data));
    }
}
